...
export const MixerControls = () => {
  ...
  const transportLabel = () =>
    hasPausedTracks() ? "Resume paused" : "Pause all";
  ...
  return (
    <Card
      as="section"
      tone="elevated"
      class="fixed inset-x-4 bottom-4 z-40 mx-auto w-auto max-w-2xl border-primary/25 bg-linear-to-r from-surface/92 via-surface/92 to-surface/88 p-3 shadow-[0_24px_56px_-36px_rgba(2,6,23,0.95)]"
    >
